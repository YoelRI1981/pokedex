...
input$$.addEventListener('input', ()=>filtrarCharacters(characters, input$$.value))
}
const filtrarCharacters = (arrayFiltrar, filtro) => {
let charactersFiltrados = arrayFiltrar.filter((characters) => characters.name.toLowerCase().includes(filtro.toLowerCase()))
